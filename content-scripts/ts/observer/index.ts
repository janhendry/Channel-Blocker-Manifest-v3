...
function createVideoObserver() {
	return [
		...
		new Observer(
			"div#items[class='style-scope ytd-watch-next-secondary-results-renderer']",
			[
				{
					...
					videoTitle: [
						"span#video-title[class=' style-scope ytd-compact-video-renderer style-scope ytd-compact-video-renderer']",
					],
					insertBlockBtn: [
						(
							element: HTMLElement,
		...
		new Observer("#comments #contents.ytd-item-section-renderer", [
			{
				...
				insertBlockBtn: [
					(
						...
						element
							.querySelector("div#header-author")
					...
					(
						...
						element
							.querySelector("span#author-comment-badge")
							?.insertAdjacentElement("beforebegin", button);
					},
				],
				transformChannelName: [
			...
			[
				{
					...
					anchorSelector:
						"div#contents[class=' style-scope ytd-item-section-renderer style-scope ytd-item-section-renderer']",
					observerOptions: [
						{
							anchorSelector:
						...
						{
							anchorSelector:
								"ytd-video-renderer[class='style-scope ytd-vertical-list-renderer']",
							userChannelName: [
								"yt-formatted-string#text[class='style-scope ytd-channel-name']",
							],
							videoTitle: [
						...
						{
							anchorSelector:
								"ytd-search-pyv-renderer[class='style-scope ytd-item-section-renderer']",
							userChannelName: [
								"a[class='yt-simple-endpoint style-scope yt-formatted-string']",
							],
							videoTitle: [
								"h3#video-title[class='style-scope ytd-promoted-video-renderer']",
							],
						},
						{
							anchorSelector:
								"ytd-ad-slot-renderer[class='style-scope ytd-item-section-renderer']",
							userChannelName: [
								"div#website-text[class='style-scope ytd-promoted-sparkles-web-renderer yt-simple-endpoint']",
							],
							videoTitle: [
								"h3#title[class='style-scope ytd-promoted-sparkles-web-renderer yt-simple-endpoint']",
							],
						},
						{
							anchorSelector:
							...
							videoTitle: [
								"span#video-title[class='style-scope ytd-playlist-renderer']",
							],
						},
						{
							anchorSelector:
					...
					subObserver: [
						{
							targetSelector:
								"ytd-shelf-renderer[class='style-scope ytd-item-section-renderer']",
